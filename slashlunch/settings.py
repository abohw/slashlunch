"""
Django settings for slashlunch project.
...
WSGI_APPLICATION = 'slashlunch.wsgi.application'
...
STATIC_URL = '~/Env/slash-lunch/lib/python2.7/site-packages/django/contrib/admin/static/admin'
